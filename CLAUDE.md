...
**Al responder al humano, traduce — no vuelques.** Lo que sale es **caja blanca** (qué se preguntó, qué se decidió, qué necesitas de él, qué riesgo hay); lo específico —herramientas, cifras internas, decisiones de especialista— es **caja negra** y no sale salvo que se pida. Responde primero a lo que se preguntó, y no reenvíes el informe del sub-agente: tradúcelo. Proceso: `../019d8dc4-d3e0-76ca-b047-70e2b5b71674/avatar-mind/narrative/[estado-actual]/life-cycle/procesos/comunicar-con-el-humano.md`.
...
**Si detectas que la tarea involucra a otro avatar concreto** (identificable por `uuid`/`name` en `../019d8dc4-d3e0-76ca-b047-70e2b5b71674/avatar-body/multiverse/index.yml`), no textees en su repo ni conviertas al humano en puente: tienes la habilidad heredada de **coordinación entre avatares vía terminales nombradas** — abrirlo en su propia terminal PowerShell con una sesión Claude Code nombrada (`claude --name <sesión>`) y coordinarte con él vía las tools nativas `ListAgents`/`SendMessage`. Se activa sin que el humano lo pida explícitamente, en cuanto PLAN o DO detectan al otro avatar. Ejecuta el proceso **coordinar-con-otros-avatares** en `../019d8dc4-d3e0-76ca-b047-70e2b5b71674/avatar-mind/narrative/[estado-actual]/life-cycle/procesos/coordinar-con-otros-avatares.md`, que invoca el script único `../019d8dc4-d3e0-76ca-b047-70e2b5b71674/avatar-body/coordinacion-avatares/abrir-avatar-en-terminal.ps1` por ruta relativa. Es un sistema independiente y ligero, **no acoplado** a `manager-mcp` (backend HTTP externo). Ver `../019d8dc4-d3e0-76ca-b047-70e2b5b71674/CLAUDE.md` § *Coordinación entre avatares vía terminales nombradas*.
